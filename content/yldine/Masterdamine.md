...
> - Kas teie projektides on olnud konkreetne piir? 
> - Kas muusikat kuulates olete mõelnud selle piiri peale?
...
- Mis masteris tehakse:
	- Tonaalne korrektuur ja täiustus
	- Dünaamiline korrektuur ja täiustus
	- Saavutatakse konkurentsivõimeline valjus
	- Kuid kõige võimsam liigutus võib olla mitte midagi teha.

---
## Stereo master

- Kasutatakse ainult lõplikku stereo *mixdown*i.

---
## Stem master

- Kasutatakse *stem*e, ehk lõplikult miksitud instrumentide gruppe.
- Võimaldab rohkem paindlikkust masterdamise protsessis. Kuid tegu pole täiendava miksimisega!

---
## Millal peaks naasema miksi juurde?

- Kui masterdamise faasis tulevad mõtted, et "sooviks kuulda seda või toda instrumenti rohkem". Siis ei olnud reaalsuse miksimise faas veel läbi. Neid muudatusi saab miksis kordades mugavamalt ja paremini kõlavalt teha kui masteris.
...
- Tõmba failid DAWis kohakuti ja ühtlusta valjuse erinevus, solo-ta nende vahel. Muidu kõlab valjem master lihtsalt paremini kui miks, kui reaalsuses võib see olla negatiivselt moondunud.
...
---
## Valikute tegemine masterdades

- Kõige mõjukam valik masterdades, võib olla mitte midagi tegemine. Kiusatusele vastu panemine. 
- Tuleb hinnata, kas muudatus lisab muusikale väärtust, või pigem röövib seda. 
	- Näiteks, kas valjuse jahtimine on väärt kõlalisi moonutusi, või mitte.
- "Paranda" eesmärgistatult. Minimaalsus on hinnatud.
> *Ask yourself, is this serving the music, or just serving my need to be useful?*
- Usalda enda kõrvu ja tööriistu AGA kui see kõlab õigesti, siis see on õige. Kuulajad kuulavad, mitte ei analüüsi.
- Kommunikeeri teiste osapooltega, nemad teavad mis visioon on. Veendu, et masterdamine ühtib selle visiooniga.

---
## "Mis su master chainis on?"

- Ei eksisteeri ühte masterdamise signaaliahelat, mida saab igal laulul kasutada. 
- Iga laul vajab eraldi lähenemist, mitte *preset*'ide kasutamist.
...
- Kasutage AINULT, kui te vähendate bit depthi. Kasutage terve loomeprotsessi vältel AINULT ühe korra. Mitmekordne ditherdamine viib kuuldava mürani.
	- Kui teie projekt on 24 bit ja teil on vaja 16 bit eksporti, siis ditherdage. 
	- Kui ekspordite 24 bit projektist 24 bit faili siis veenduge, et dither oleks maas!

<!-- hide -->
>NOTE:
>- [24 vs 16bit.RPP](file:///Users/mattiasprt/Library/CloudStorage/Dropbox/ÕPETAMINE/24%20vs%2016bit/24%20vs%2016bit.RPP)
...
---
## Teemakohane artikkel mis minu mõttemaailma mõjutas

- https://www.soundonsound.com/techniques/what-mastering-can-cant-do
- Sound On Sound
...
---
<!-- /hide -->
## Kuidas otsida enda tööle masterdajat?
