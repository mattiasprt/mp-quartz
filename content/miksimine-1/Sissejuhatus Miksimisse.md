...
---
![[04 - Õpetamine/Ained/Miksimine (1. osa)#Üldinfo]]
...
- Võtta kõik salvestatud ja produtseeritud materjal ning luua sobilik kooskõla, mis on balanseeritud ja sobilik (žanriliselt ja/või isikupäraselt), viia täide artistlik visioon.
	...
	4. Emotsioon ja vaib: Tee seda mis tundub õige.
- Miks me lihtsalt siis ei salvesta või produtseeri perfektselt, miks vaja miksimist?
	- Sest kanalite vahelist faasisuhet on keeruline salvestuse käigus kontrollida. 
	- Sageduslikku *masking*'ut saab samuti paremini kontrollida tagantjärgi.
	- Kuiv salvestus kõlab igavalt, efektid loovad meeleolu
	- Inimesed teevad vigu ja ei ole perfektsed, vigu saab enamasti parandada parema muusikalise elamuse nimel.
	- Artist või bänd ei pruugi olla võimeline iseseisvalt oma artistliku visiooni täide viima, koostöös miksijaga loksuvad tihti kõlalised pusletükid paika.

---

## Miks on miksimise õppimine produtsentidele tähtis?

- Teie kliendid ootavad kõrge kvaliteediga kõla nii kiiresti kui võimalik. Ootused on kõrged ja hea saund määrab hea vaibi nii ruumis kui ka koostöös. Produtsent peab olema teadlik miksimise töövõtetest, et produtseerida kõrgel tasemel. <!-- element class="fragment"-->
- Miksimise õppimine õpetab ka kuidas heliinseneriga suhelda ja koostööd teha. Kuidas tagasisidestada enda produktsioonide mikse. Õpetab milline on tööprotsess, sobilik sõnavara ja kuidas "kuulata".<!-- element class="fragment"-->
- Tahes tahtmata liigume maailma suunas kus ühe ala või nišši spetsialistid on vähem hinnas, kui need kes on spetsialistid mitmel alal.<!-- element class="fragment"-->

---
## Mõned miksimise põhitõed (inseneri perspektiivist)
...
- Tegu on valdkonnaga kus on ääretult palju snake-oil'i, valeinfot, clickbaiti ja turundus trikke.
- Pluginate turundus on tihtipeale suunatud algajatele. *"Kui sul seda pluginat ei ole, siis su miksid ei hakka kunagi hästi kõlama!!1!"*
- Kui keegi toob välja probleemi, mille olemasolust sa ei olnud teadlik ja nad müüvad sulle lahendust sellele probleemile. Siis mõtle nende motiividele.
- Lugege kommentaare ja review'sid. Kuid arvestage, et väga paljud ei tea millest nad räägivad..
- Tööriistad pluginate ostmiseks: 
	- Isiklikult olen kasutanud: https://plugindeals.net/ ja https://www.facebook.com/groups/916355121807800
	- https://musicsoftwaredeals.com/
	- https://pluginplug.io/deals
	- https://audiobazooka.com/
- [Kui juba pluginaid liiga palju, siis Mac'i kasutajatele selline app.](https://www.widebluesound.com/audio-plugin-uninstaller/)

---

## Platseebo

- Miksid kõlavad paremini, kui sa ei vaata ekraani.
- Olge teadlikud sellest, et **valjem kõlab "paremini"**.
- Demo võib kõlada paremini kui miksi V1 ainult selle pärast, et sa oled harjunud sellega. 
- Kõige selgem perspektiiv tuleb, kui kuulata sarnast muusikat käesoleva miksiga võrdluses.

---

## Miksimine on loov protsess!

- Ärge kohtelge seda kui ainult tehnilist etappi. Jah, tegu on post-produktsiooniga, kuid see on ju endiselt produktsioon :o
- [Ebameeldiv mees rääkimas mõistlikku juttu.](https://www.instagram.com/reel/DLShpdOqPLh/ )

---
## [Joey Valence!](https://www.youtube.com/live/dmkDZs9Qekc?si=gx9WAoFmqT67wYRr&t=353)

<iframe width="560" height="315" src="https://www.youtube.com/embed/dmkDZs9Qekc?si=SFtADr6H7xDmY3dn&amp;start=352" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

---

## Kus on piir produ ja miksi vahel?
...
## [Manny Marroquin!](https://youtu.be/ZZTNrLmK_gs?si=dX0gqGAUDFgT6ZND&t=211)

<iframe width="560" height="315" src="https://www.youtube.com/embed/ZZTNrLmK_gs?si=wOGha7xJrzOBa4Yc&amp;start=214" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

---
## Kus on piir miksi ja masteri vahel?

NOTE:
> - Mis on üldse masterdamine? Räägime Miksimine 3 aines.
> 	- Miksimine on individuaalsed audio träkid ja/või stemid. Masterdamises töötatakse mixi stereo faili expordiga. 
> 	- Lõplik lihv enne distributsiooni.
> - Ideaalis võiks olla teine inimene, värsked kõrvad.
> - Kogumikel luuakse kohesiivne tervik.
> - Piiri tõmbamine säästab CPUd ja närvirakke.
...
- Miks ja master ei saa "parandada" ega täiendada laulu, vaid protsessid saavad luua selgust ja arendada kõlapilti.
- Laulu kõlal on ettemääratletud tulemus, vastavalt algmaterjalile. Kõik algab laulukirjutamisest, arranžeeringust ja produktsioonist.
